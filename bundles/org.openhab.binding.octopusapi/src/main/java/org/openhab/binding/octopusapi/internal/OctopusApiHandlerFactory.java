...
/**
 * The {@link OctopusApiHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class OctopusApiHandlerFactory extends BaseThingHandlerFactory {
    ...
    @Activate
    public OctopusApiHandlerFactory(final @Reference HttpClientFactory httpClientFactory) {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_OCTOPUSAPI.equals(thingTypeUID)) {
            return new OctopusApiHandler(thing, httpClient);
        }
