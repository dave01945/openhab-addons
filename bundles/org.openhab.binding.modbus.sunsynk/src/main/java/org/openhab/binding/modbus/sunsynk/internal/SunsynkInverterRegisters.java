...
public enum SunsynkInverterRegisters {
    ...
    SETTING_BATT_ABSORPTION_VOLT(202, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-battery"),
    SETTING_BATT_FLOAT_VOLT(203, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-battery"),
    SETTING_BATT_MAX_CHARGE_CURRENT(210, UINT16, BigDecimal.ONE, quantityFactory(Units.AMPERE), "settings-battery"),
    SETTING_BATT_MAX_DISCHARGE_CURRENT(211, UINT16, BigDecimal.ONE, quantityFactory(Units.AMPERE), "settings-battery"),
    SETTING_BATT_SHUTDOWN_CAP(217, UINT16, BigDecimal.ONE, quantityFactory(Units.PERCENT), "settings-battery"),
    SETTING_BATT_RESTART_CAP(218, UINT16, BigDecimal.ONE, quantityFactory(Units.PERCENT), "settings-battery"),
    SETTING_BATT_LOW_CAP(219, UINT16, BigDecimal.ONE, quantityFactory(Units.PERCENT), "settings-battery"),
    SETTING_BATT_SHUTDOWN_VOLT(220, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-battery"),
    SETTING_BATT_RESTART_VOLT(221, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-battery"),
    ...
    // Timer program voltage settings
    SETTING_PROG1_VOLTAGE(262, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-timer"),
    SETTING_PROG2_VOLTAGE(263, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-timer"),
    SETTING_PROG3_VOLTAGE(264, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-timer"),
    SETTING_PROG4_VOLTAGE(265, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-timer"),
    SETTING_PROG5_VOLTAGE(266, UINT16, ConversionConstants.DIV_BY_HUNDRED, quantityFactory(Units.VOLT),
            "settings-timer"),
